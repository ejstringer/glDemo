...
Download the file [sample_data_2Row.csv]{style="color:blue; font-family: 'Courier New';"} [`r xfun::embed_file("./www/sample_data_2row.csv", text = "(click to download)")`]{style="font-family: 'Courier New';"} and place it in the working directory. If you like you can open the file in Excel 
...
<small>Below are two tabs, the first is the code and the second is the output generated when running the code - loading in a dartR object.</small>
