...
### [What do we have in the way of individual metrics?]{style="color:black; font-weight:bold; font-size:18px"}
...
### [Next, undertake some basic diagnostics:]{style="color:black; font-weight:bold; font-size:18px"}
...
### [What do we have in the way of locus metrics?]{style="color:black; font-weight:bold; font-size:18px"}
...
<summary><b>[Hints </b>]{style="color:orange; cursor:pointer"}(click to expand)</summary>
...
<summary>[Solutions ]{style="color:orange; cursor:pointer"}(click to expand)</summary>
